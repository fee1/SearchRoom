(function ($) {
    ...
    $(function () {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '/user-service/admin/add/upload/photo',
            // runtimeOrder: 'flash',
        ...
        function addFile(file) {
            var $li = $('<div style="float: left; margin: 2px; padding: 2px; border: 1px dashed; width:' +
                ' 120px; height: 100px;"><li id="' + file.id + '">' +
        ...
        uploader.onUploadSuccess = function (file, response) {
            ...
            $("#upload-cover-container").append(
                ...
                ' 120px; height: 100px;">' +
                '<span><img src="'+photo_path+'" title="待选封面" width="120px" height="100px" />' +
